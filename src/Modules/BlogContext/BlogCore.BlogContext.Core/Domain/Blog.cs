...
namespace BlogCore.BlogContext.Core.Domain
{
    public class Blog : EntityBase
    {
        ...
        private static void AssertImageFilePath(string imageFilePath)
        {
            ...
            {
                throw new BlogCore.Core.ValidationException("The path of image could not be null or empty.");
            }
        }
        ...
        private static void AssertOwnerEmail(string ownerEmail)
        {
            ...
            {
                throw new BlogCore.Core.ValidationException("The email of owner could not be null or empty.");
            }
        }
